...
namespace{
class testForceDesiredWrench : public ::testing::Test {
 protected:

  testForceDesiredWrench()
  {

  }

  virtual ~testForceDesiredWrench() {
  }
...
TEST_F(testForceDesiredWrench, testContactWrenchDesired) {
    ...
    OpenSoT::tasks::force::DesiredWrench::Ptr cw(new OpenSoT::tasks::force::DesiredWrench(w_desired, coman));
