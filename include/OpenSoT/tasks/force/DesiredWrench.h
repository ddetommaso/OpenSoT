...
#ifndef __TASKS_FORCE_DESIRED_WRENCH_H__
#define __TASKS_FORCE_DESIRED_WRENCH_H__
 ...
 namespace OpenSoT {
    namespace tasks {
        namespace force {
            ...
            class DesiredWrench : public Task < yarp::sig::Matrix, yarp::sig::Vector > {
            public:
                typedef boost::shared_ptr<DesiredWrench> Ptr;
            protected:
                /**
            ...
            public:
                ...
                DesiredWrench(const yarp::sig::Vector& x, iDynUtils& robot);
