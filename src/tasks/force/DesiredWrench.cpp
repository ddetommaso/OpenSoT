...
DesiredWrench::DesiredWrench(const yarp::sig::Vector& x, iDynUtils &robot) :
...
void DesiredWrench::_update(const yarp::sig::Vector &x) {
    /**
...
void DesiredWrench::setReference(const yarp::sig::Vector& x_desired) {
...
yarp::sig::Vector DesiredWrench::getReference() const
{
    return _w_desired;
}

void DesiredWrench::update_b() {
    _b = _w_desired;
}
